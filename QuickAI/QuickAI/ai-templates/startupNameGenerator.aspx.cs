...
{
    public partial class startupNameGenerator : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "startupNameGeneratorID", "startupNameGeneratorID();", true);
        }
    }
}