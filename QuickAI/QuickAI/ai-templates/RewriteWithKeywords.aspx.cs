...
{
    public partial class RewriteWithKeywords : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "rewriteWithKeywordsID", "rewriteWithKeywordsID();", true);
        }
    }
}