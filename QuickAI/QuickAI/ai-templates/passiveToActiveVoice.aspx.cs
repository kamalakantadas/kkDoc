...
{
    public partial class passiveToActiveVoice : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "passiveToActiveID", "passiveToActiveID();", true);
        }
    }
}