<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="testimonial-reviews.aspx.cs" Inherits="QuickAI.ai_templates.testimonial_reviews" %>
...
<head runat="server">
    ...
    <script src="../Scripts/testimonialReviews.js"></script>
</head>
<body>
    <form id="testimonialsReview" runat="server">
        <div id="tRForm">
            <div id="dHeader">
                <%-- Testimonial Header --%>
                    ...
                    <div class="col-lg-9 scrollable" id="content"  style="width:75%;background:#f2f2f2;z-index:99;padding-left:50px;padding-top:50px;">
                        <div id="rightSide">
                               <div class="row" >
                                   ...
                                   <div class="col-md-6">
                                       <h4>Testimonials/Reviews</h4>  <span class="rounded-capsule" id="wordsUsedCount">0/10,000 Words Used</span>                                     
                                   </div>                                   
