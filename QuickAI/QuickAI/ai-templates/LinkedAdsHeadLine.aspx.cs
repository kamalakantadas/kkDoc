...
{
    public partial class LinkedAdsHeadLine : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "LinkedAdsHeadLineID", "LinkedAdsHeadLineID();", true);
        }
    }
}