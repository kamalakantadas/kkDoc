...
{
    public partial class SocialMediaPost_Personal_ : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "socialMediaPostPersonal", "socialMediaPostPersonal();", true);
        }
    }
}