            ...
            <div class="row" style="display: inline-flex;">
                ...
                <div class="col-lg-9 scrollable" id="content" style="background: #f2f2f2;">
                    <div id="aiRightDiv">
                        ...
                        <%-- search --%>
                        <div class="row mb-3" style="height: 45px; background: white;border-radius:25px">
                            <input id="selectTempID" type="text" style="border: none; outline: none;width:95%;margin-left:20px;" />
                        </div>
                        <div class="row" style="border-radius:35px;background:skyblue">
                            <div class="col-md-12">
                                <div id="allTempHead">
