                   ...
                   <div class="row" style="display: inline-flex; width: 100%;margin-top:95px">
                       ...
                       <div class="col-lg-9 scrollable" id="content" style="width: 75%; background: #f2f2f2; z-index: 99; padding-top: 50px;">
                           ...
                           <div class="row" id="allTemp" style="padding-left:50px;padding-right:50px;padding-bottom:50px">                              
                               ...
                               <%-- ecommerce --%>
                               <div class="row templ" id="ece" style="padding-top:20px;padding-bottom:20px">
                                   <div class="row">
                                       <div class="row">
                                           <h4>Ecommerce</h4>
                                       </div>
                               ...
                               <%-- social media --%>
                               <div class="row templ" id="sma" style="padding-top:20px;padding-bottom:20px">
                                   <div class="row">
                                       <h4>Social Media</h4>
                                   </div>
                                    <div class="row">
                               ...
                               <%-- website --%>
                               <div class="row templ" id="webe" style="padding-top:20px;padding-bottom:20px">
                                   <div class="row">
                                       <h4>Website</h4>
                                   </div>
                                   <div class="row">
                               ...
                               <%-- others --%>
                               <div class="row templ" id="oth" style="padding-top:20px;padding-bottom:20px">
                                   <div class="row">
                                       <h4>Other</h4>
                                   </div>
                                   <div class="row">
