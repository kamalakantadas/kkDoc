<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Templates.aspx.cs" Inherits="QuickAI.ai_templates.Templates" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server" id="templatesHeader">
    ...
    <script src="../Scripts/allTemplates.js"></script>
</head>
                        ...
                        <div id="rightside">
                            <div class="row" >
                                   ...
                                   <div class="col-md-6" style="display:flex">
                                       <p id="formMainHeader">faq answers/reviews</p>
                                   ...
                                   <div class="col-md-6">
                                       <div id="subpage">
                                           <ul style="display: inline-flex;">
                                               ...
                                               <li><a id="pageLink" href="testimonial-reviews.aspx">testimonials/reviews</a></li>                                              
                                           </ul>
                                       </div>
                                   </div>
                               </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="row" style="background-color: white; margin-left: 10px; box-shadow: 0px 1px 7px 1px;">
                                        <div class="row" style="width: 90%; padding: 20px; margin-left: 10px; border-bottom: 1px solid grey">
                                            ...
                                            <h6 id="formHeader">faq answers</h6>
                                        </div>
                                        <div class="row" style="margin: 20px; padding: 5px; background-color: cornflowerblue;">
                                            <p id="formInnerDiv" class="small">add social proof to your website by generating user testimonials.</p>
                                        </div>
