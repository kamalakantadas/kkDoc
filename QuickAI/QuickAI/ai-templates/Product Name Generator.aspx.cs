...
{
    public partial class Product_Name_Generator : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "ProductNameGeneratorID", "ProductNameGenerator();", true);
        }
    }
}