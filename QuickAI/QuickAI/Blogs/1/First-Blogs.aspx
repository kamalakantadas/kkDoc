<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="First-Blogs.aspx.cs" Inherits="QuickAI.Blogs._1.First_Blogs" %>
                                ...
                                <div class="row">
                                    <div class="col-lg-8" style="box-shadow: 2px 2px 5px grey;margin-top:10px">
                                        ...
                                        <div class="row" style="padding-bottom:10px;padding-left:15px">
                                            you are commenting as: <div id="userName"></div>
                                        </div>
                                        ...
                                        <div id="form-group" style="padding-top:20px">
                                            <asp:Button ID="cmntPost" runat="server" class="btn btn-primary" Text="Submit" style="Width:150px;margin-bottom:20px"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-4"></div>
                                </div>
