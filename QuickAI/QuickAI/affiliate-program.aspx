                ...
                <div class="col-lg-9 scrollable" id="content" style="background: #f2f2f2;">
                    <div id="rightSide">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="row" id="wordsUsed">
                                    ...
                                    <div class="col-md-4" style="background-color: rgba(184, 27, 127, 0.07);">
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="row" id="imagesUsed">
                                    ...
                                    <div class="col-lg-6 col-md-4" style="color: rgb(54, 189, 120);">
                            ...
                            <%-- Total Earning--%>
                            <div class="col-lg-4 col-md-12">
                                <div class="row" id="speechText">
                                    <div class="col-lg-6 col-md-8">
                                        <div id="st">
                                            <h5>Total Earning</h5>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-4" style="color: rgb(239, 168, 15);">
                        ...
                        <div class="row" id="mDiv">
                            ...
                            <hr />
                            <%-- TextContext --%>
                            <div id="mSubDiv2" style="background-color: cornflowerblue; margin: 10px; padding: 5px;">
                        ...
                        <div class="row" id="mSubDiv3">
                            <div class="col-lg-6">
                                <div>
                                    <p class="text-muted">Current <span class="glyphicon-bold">Commission Rate</span></p>
                        ...
                        <div id="mSubDiv4">
                            ...
                            <div class="row">   
                                <div class="col-md-6">
                                   <span><input type="text" id="copyTxt" class="in1" value="Index.aspx" readonly="" /> </span>
                                   <span> <a id="copyBtn" class="form-control1" style="">
                                        <i class="fa fa-copy" style="color: cornflowerblue; pointer-events: none;"></i>
                                    </a></span>
                                </div>
                        ...
                        <%-- Table End --%>
                        <%-- Footer Dashboard --%>
                        <div class="row footer" style="padding-bottom: 80px; border-top: 1px solid #ccc;">
                            <div class="col-md-6">
