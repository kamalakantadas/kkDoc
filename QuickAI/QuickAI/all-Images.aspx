<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="all-Images.aspx.cs" Inherits="QuickAI.all_Images" %>
                            ...
                            <div class="col-md-4">
                                <div id="SubPage">
                                    <ul style="display: inline-flex;">
                                        ...
                                        <li><a href="all-Images.aspx">All Images</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div style="background: white; padding: 40px; margin-bottom: 80px;">
                            <div style="width: 100%;">
                                <h5>All Images</h5>
                            </div>
                            <hr />
